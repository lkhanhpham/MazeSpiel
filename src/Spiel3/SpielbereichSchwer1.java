...
public class SpielbereichSchwer1 extends JPanel implements ComponentListener, MouseListener, KeyListener {
	...
	boolean showimage810 = false;
	boolean showimage911 = false;
	...
	boolean showedge810 = false;
	boolean showedge911 = false;
	...
	public SpielbereichSchwer1() {
		addMouseListener(this);
		addKeyListener(this);
		addComponentListener(this);
		setFocusable(true);
		graph = new Graph(12, 1);
	...
	public void paint(Graphics g) {
		...
		for (int i = 0; i < graph.knotenanzahl; i++) {
			if (i == 0) {
				...
				g.setColor(Color.blue);
				g.fillOval(recs[6][1].x, recs[6][1].y, cellSize, cellSize);
				g.drawString("2", recs[6][1].x, recs[6][1].y);
			} else if (i == 3) {
				g.setColor(Color.blue);
				g.fillOval(recs[6][12].x, recs[6][12].y, cellSize, cellSize);
				g.drawString("3", recs[6][12].x, recs[6][12].y);
			} else if (i == 4) {
				g.setColor(Color.blue);
				...
				g.drawString("6", recs[10][1].x, recs[10][1].y);
			} else if (i == 7) {
				g.setColor(Color.blue);
				g.fillOval(recs[10][12].x, recs[10][12].y, cellSize, cellSize);
				g.drawString("7", recs[10][12].x, recs[10][12].y);
			} else if (i == 8) {
				g.setColor(Color.blue);
				g.fillOval(recs[12][1].x, recs[12][1].y, cellSize, cellSize);
				g.drawString("8", recs[12][1].x, recs[12][1].y);
			} else if (i == 9) {
				g.setColor(Color.blue);
				g.fillOval(recs[12][12].x, recs[12][12].y, cellSize, cellSize);
				g.drawString("9", recs[12][12].x, recs[12][12].y);
			} else if (i == 10) {
				g.setColor(Color.blue);
				g.fillOval(recs[14][1].x, recs[14][1].y, cellSize, cellSize);
				g.drawString("10", recs[14][1].x, recs[14][1].y);
			} else if (i == 11) {
				g.setColor(Color.blue);
				g.fillOval(recs[14][12].x, recs[14][12].y, cellSize, cellSize);
				g.drawString("11", recs[14][12].x, recs[14][12].y);
			}
		...
		for (int i = 0; i < graph.knotenanzahl; i++) {
			for (int j = 0; j < graph.knotenanzahl; j++) {
				if (i == 0 && j == 1) {
					...
					g.setColor(Color.black);
					g.drawLine(recs[5][1].x + (cellSize / 2), recs[5][1].y, recs[6][1].x + (cellSize / 2),
							recs[6][1].y);
					gewicht2 = String.valueOf(graph.adjazenzmatrix[0][2]);
					g.drawString(gewicht2, (recs[5][1].x + (cellSize / 2) + recs[6][1].x + (cellSize / 2)) / 2,
							(recs[5][1].y + recs[6][1].y) / 2);
				} else if (i == 1 && j == 3) {
					g.setColor(Color.black);
					g.drawLine(recs[5][12].x + (cellSize / 2), recs[5][12].y, recs[6][12].x + (cellSize / 2),
							recs[6][12].y);
					gewicht3 = String.valueOf(graph.adjazenzmatrix[1][3]);
					g.drawString(gewicht3, (recs[5][12].x + (cellSize / 2) + recs[6][12].x + (cellSize / 2)) / 2,
							(recs[5][12].y + recs[6][12].y) / 2);
				} else if (i == 2 && j == 3) {
					g.setColor(Color.black);
					g.drawLine(recs[6][2].x, recs[6][2].y + (cellSize / 2), recs[6][12].x,
							recs[6][12].y + (cellSize / 2));
					gewicht4 = String.valueOf(graph.adjazenzmatrix[2][3]);
					g.drawString(gewicht4, (recs[6][2].x + recs[6][12].x) / 2,
							(recs[6][2].y + (cellSize / 2) + recs[6][12].y + (cellSize / 2)) / 2);
				} else if (i == 2 && j == 4) {
					g.setColor(Color.black);
					g.drawLine(recs[7][1].x + (cellSize / 2), recs[7][1].y, recs[8][1].x + (cellSize / 2),
							recs[8][1].y);
					gewicht5 = String.valueOf(graph.adjazenzmatrix[2][4]);
					g.drawString(gewicht5, (recs[7][1].x + (cellSize / 2) + recs[8][1].x + (cellSize / 2)) / 2,
							(recs[7][1].y + recs[8][1].y) / 2);
				} else if (i == 3 && j == 5) {
					g.setColor(Color.black);
					g.drawLine(recs[7][12].x + (cellSize / 2), recs[7][12].y, recs[8][12].x + (cellSize / 2),
							recs[8][12].y);
					gewicht6 = String.valueOf(graph.adjazenzmatrix[3][5]);
					g.drawString(gewicht6, (recs[7][12].x + (cellSize / 2) + recs[8][12].x + (cellSize / 2)) / 2,
							(recs[7][12].y + recs[8][12].y) / 2);
				} else if (i == 4 && j == 5) {
					g.setColor(Color.black);
					g.drawLine(recs[8][2].x, recs[8][2].y + (cellSize / 2), recs[8][12].x,
							recs[8][12].y + (cellSize / 2));
					gewicht7 = String.valueOf(graph.adjazenzmatrix[4][5]);
					g.drawString(gewicht7, (recs[8][2].x + recs[8][12].x) / 2,
							(recs[8][2].y + (cellSize / 2) + recs[8][12].y + (cellSize / 2)) / 2);
				} else if (i == 4 && j == 6) {
					g.setColor(Color.black);
					g.drawLine(recs[9][1].x + (cellSize / 2), recs[9][1].y, recs[10][1].x + (cellSize / 2),
							recs[10][1].y);
					gewicht8 = String.valueOf(graph.adjazenzmatrix[4][6]);
					g.drawString(gewicht8, (recs[9][1].x + (cellSize / 2) + recs[10][1].x + (cellSize / 2)) / 2,
							(recs[9][1].y + recs[10][1].y) / 2);
				} else if (i == 5 && j == 7) {
					g.setColor(Color.black);
					g.drawLine(recs[9][12].x + (cellSize / 2), recs[9][12].y, recs[10][12].x + (cellSize / 2),
							recs[10][12].y);
					gewicht9 = String.valueOf(graph.adjazenzmatrix[5][7]);
					g.drawString(gewicht9, (recs[9][12].x + (cellSize / 2) + recs[10][12].x + (cellSize / 2)) / 2,
							(recs[9][12].y + recs[10][12].y) / 2);
				} else if (i == 6 && j == 7) {
					g.setColor(Color.black);
					g.drawLine(recs[10][2].x, recs[10][2].y + (cellSize / 2), recs[10][12].x,
							recs[10][12].y + (cellSize / 2));
					gewicht10 = String.valueOf(graph.adjazenzmatrix[6][7]);
					g.drawString(gewicht10, (recs[10][2].x + recs[10][12].x) / 2,
							(recs[10][2].y + (cellSize / 2) + recs[10][12].y + (cellSize / 2)) / 2);
				} else if (i == 6 && j == 8) {
					g.setColor(Color.black);
					g.drawLine(recs[11][1].x + (cellSize / 2), recs[11][1].y, recs[12][1].x + (cellSize / 2),
							recs[12][1].y);
					gewicht11 = String.valueOf(graph.adjazenzmatrix[6][8]);
					g.drawString(gewicht11, (recs[11][1].x + (cellSize / 2) + recs[12][1].x + (cellSize / 2)) / 2,
							(recs[11][1].y + recs[12][1].y) / 2);
				} else if (i == 7 && j == 9) {
					g.setColor(Color.black);
					g.drawLine(recs[11][12].x + (cellSize / 2), recs[11][12].y, recs[12][12].x + (cellSize / 2),
							recs[12][12].y);
					gewicht12 = String.valueOf(graph.adjazenzmatrix[7][9]);
					g.drawString(gewicht12, (recs[11][12].x + (cellSize / 2) + recs[12][12].x + (cellSize / 2)) / 2,
							(recs[11][12].y + recs[12][12].y) / 2);
				} else if (i == 8 && j == 9) {
					g.setColor(Color.black);
					g.drawLine(recs[12][2].x, recs[12][2].y + (cellSize / 2), recs[12][12].x,
							recs[12][12].y + (cellSize / 2));
					gewicht13 = String.valueOf(graph.adjazenzmatrix[8][9]);
					g.drawString(gewicht13, (recs[12][2].x + recs[12][12].x) / 2,
							(recs[12][2].y + (cellSize / 2) + recs[12][12].y + (cellSize / 2)) / 2);
				} else if (i == 8 && j == 10) {
					g.setColor(Color.black);
					g.drawLine(recs[13][1].x + (cellSize / 2), recs[13][1].y, recs[14][1].x + (cellSize / 2),
							recs[14][1].y);
					gewicht14 = String.valueOf(graph.adjazenzmatrix[8][10]);
					g.drawString(gewicht14, (recs[13][1].x + (cellSize / 2) + recs[14][1].x + (cellSize / 2)) / 2,
							(recs[13][1].y + recs[14][1].y) / 2);
				} else if (i == 9 && j == 11) {
					g.setColor(Color.black);
					g.drawLine(recs[13][12].x + (cellSize / 2), recs[13][12].y, recs[14][12].x + (cellSize / 2),
							recs[14][12].y);
					gewicht15 = String.valueOf(graph.adjazenzmatrix[9][11]);
					g.drawString(gewicht15, (recs[13][12].x + (cellSize / 2) + recs[14][12].x + (cellSize / 2)) / 2,
							(recs[13][12].y + recs[14][12].y) / 2);
				} else if (i == 10 && j == 11) {
					g.setColor(Color.black);
					g.drawLine(recs[14][2].x, recs[14][2].y + (cellSize / 2), recs[14][12].x,
							recs[14][12].y + (cellSize / 2));
					gewicht16 = String.valueOf(graph.adjazenzmatrix[10][11]);
					g.drawString(gewicht16, (recs[14][2].x + recs[14][12].x) / 2,
							(recs[14][2].y + (cellSize / 2) + recs[14][12].y + (cellSize / 2)) / 2);
				}
		...
		if (showimage02 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[5][1].x, recs[5][1].y, cellSize, cellSize, null);
		}
		if (showimage13 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[5][12].x, recs[5][12].y, cellSize, cellSize, null);
		}
		if (showimage23 == true) {
			g.drawImage(Graph.getRohrhorizontal(), recs[6][2].x, recs[6][2].y, recs[6][9].x, cellSize, null);
		}
		if (showimage24 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[7][1].x, recs[7][1].y, cellSize, cellSize, null);
		}
		if (showimage35 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[7][12].x, recs[7][12].y, cellSize, cellSize, null);
		}
		if (showimage45 == true) {
			g.drawImage(Graph.getRohrhorizontal(), recs[8][2].x, recs[8][2].y, recs[8][9].x, cellSize, null);
		}
		if (showimage46 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[9][1].x, recs[9][1].y, cellSize, cellSize, null);
		}
		if (showimage57 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[9][12].x, recs[9][12].y, cellSize, cellSize, null);
		}
		if (showimage67 == true) {
			g.drawImage(Graph.getRohrhorizontal(), recs[10][2].x, recs[10][2].y, recs[10][9].x, cellSize, null);
		}
		if (showimage68 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[11][1].x, recs[11][1].y, cellSize, cellSize, null);
		}
		if (showimage79 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[11][12].x, recs[11][12].y, cellSize, cellSize, null);
		}
		if (showimage89 == true) {
			g.drawImage(Graph.getRohrhorizontal(), recs[12][2].x, recs[12][2].y, recs[12][9].x, cellSize, null);
		}
		if (showimage810 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[13][1].x, recs[13][1].y, cellSize, cellSize, null);
		}
		if (showimage911 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[13][12].x, recs[13][12].y, cellSize, cellSize, null);
		}
		if (showimage1011 == true) {
			g.drawImage(Graph.getRohrhorizontal(), recs[14][2].x, recs[14][2].y, recs[14][9].x, cellSize, null);
		}
	}
	...
	public void mouseClicked(MouseEvent e) {
		if (mouseclick2 == true) {
			...
			if (recs[5][1].y < e.getY() && e.getY() < recs[6][1].y && recs[5][1].x < e.getX()
					&& e.getX() < recs[5][2].x) {
				if (counter02 == 0) {
					showimage02 = true;
					repaint();
			...
			if (showedge01 == true || showedge23 == true || showedge35 == true) {
				if (recs[5][12].y < e.getY() && e.getY() < recs[6][12].y && recs[5][12].x < e.getX()
						&& e.getX() < recs[5][13].x) {
					if (counter13 == 0) {
						showimage13 = true;
						repaint();
			...
			if (showedge02 == true || showedge13 == true || showedge24 == true || showedge35 == true) {
				if (recs[6][2].x < e.getX() && e.getX() < recs[6][12].x && recs[6][2].y < e.getY()
						&& e.getY() < recs[7][2].y) {
					if (counter23 == 0) {
						showimage23 = true;
						repaint();
			...
			if (showedge02 == true || showedge23 == true || showedge45 == true || showedge46 == true) {
				if (recs[7][1].y < e.getY() && e.getY() < recs[8][1].y && recs[7][1].x < e.getX()
						&& e.getX() < recs[7][2].x) {
					if (counter24 == 0) {
						showimage24 = true;
						repaint();
			...
			if (showedge23 == true || showedge13 == true || showedge45 == true || showedge57 == true) {
				if (recs[7][12].y < e.getY() && e.getY() < recs[8][12].y && recs[7][12].x < e.getX()
						&& e.getX() < recs[7][13].x) {
					if (counter35 == 0) {
						showimage35 = true;
						repaint();
			...
			if (showedge24 == true || showedge35 == true || showedge46 == true || showedge57 == true) {
				if (recs[8][2].x < e.getX() && e.getX() < recs[8][12].x && recs[8][2].y < e.getY()
						&& e.getY() < recs[9][2].y) {
					if (counter45 == 0) {
						showimage45 = true;
						repaint();
			...
			if (showedge24 == true || showedge45 == true || showedge67 == true || showedge68 == true) {
				if (recs[9][1].y < e.getY() && e.getY() < recs[10][1].y && recs[9][1].x < e.getX()
						&& e.getX() < recs[9][2].x) {
					if (counter46 == 0) {
						showimage46 = true;
						repaint();
			...
			if (showedge35 == true || showedge45 == true || showedge67 == true || showedge79 == true) {
				if (recs[9][12].y < e.getY() && e.getY() < recs[10][12].y && recs[9][12].x < e.getX()
						&& e.getX() < recs[9][13].x) {
					if (counter57 == 0) {
						showimage57 = true;
						repaint();
			...
			if (showedge46 == true || showedge57 == true || showedge68 == true || showedge79 == true) {
				if (recs[10][2].x < e.getX() && e.getX() < recs[10][12].x && recs[10][2].y < e.getY()
						&& e.getY() < recs[11][2].y) {
					if (counter67 == 0) {
						showimage67 = true;
						repaint();
			...
			if (showedge46 == true || showedge67 == true || showedge89 == true || showedge810 == true) {
				if (recs[9][12].y < e.getY() && e.getY() < recs[10][12].y && recs[9][12].x < e.getX()
						&& e.getX() < recs[9][13].x) {
					if (counter68 == 0) {
						showimage68 = true;
			...
			if (showedge57 == true || showedge67 == true || showedge89 == true || showedge911 == true) {
				if (recs[11][12].y < e.getY() && e.getY() < recs[12][12].y && recs[11][12].x < e.getX()
						&& e.getX() < recs[11][13].x) {
					if (counter79 == 0) {
						showimage79 = true;
						repaint();
			...
			if (showedge68 == true || showedge79 == true || showedge810 == true || showedge911 == true) {
			...
			if (showedge68 == true || showedge89 == true || showedge1011 == true) {
				if (recs[13][1].y < e.getY() && e.getY() < recs[14][1].y && recs[13][1].x < e.getX()
						&& e.getX() < recs[13][2].x) {
					if (counter810 == 0) {
						showimage810 = true;
						repaint();
						lösung3 += Integer.valueOf(gewicht14);
						anzahlkanten3 += 1;
						counter810 = 1;
						showedge810 = true;
						abwählen.push("n");
			...
			if (showedge68 == true || showedge89 == true || showedge1011 == true) {
				if (recs[13][12].y < e.getY() && e.getY() < recs[14][12].y && recs[13][12].x < e.getX()
						&& e.getX() < recs[13][13].x) {
					if (counter911 == 0) {
						showimage911 = true;
						repaint();
						lösung3 += Integer.valueOf(gewicht15);
						anzahlkanten3 += 1;
						counter911 = 1;
						showedge911 = true;
						abwählen.push("o");
			...
			if (showedge810 == true || showedge911 == true) {
				if (recs[14][2].x < e.getX() && e.getX() < recs[14][12].x && recs[14][2].y < e.getY()
						&& e.getY() < recs[15][2].y) {
					if (counter1011 == 0) {
						showimage1011 = true;
						repaint();
						lösung3 += Integer.valueOf(gewicht16);
						anzahlkanten3 += 1;
						counter89 = 1;
						showedge1011 = true;
						abwählen.push("p");
	...
	public class ClickListener extends MouseAdapter {
		...
		public void mouseReleased(MouseEvent evt) {
			...
			for (int i = 0; i < 7; i++) {
				...
				if (showedge02 == true) {
					if (recs[6][1].x < image_corner.x && image_corner.x < recs[6][2].x && recs[6][1].y < image_corner.y
							&& image_corner.y < recs[7][1].y) {
						set = true;
						extrarohrmoved = true;
					}
				}
				...
				if (showedge13 == true) {
					if (recs[4][1].x < image_corner.x && image_corner.x < recs[4][2].x && recs[4][1].y < image_corner.y
							&& image_corner.y < recs[5][1].y
							|| recs[6][12].x < image_corner.x && image_corner.x < recs[6][13].x
									&& recs[6][12].y < image_corner.y && image_corner.y < recs[7][12].y) {
						set = true;
						extrarohrmoved = true;
					}
				}
				...
				if (showedge35 == true) {
					if (recs[6][12].x < image_corner.x && image_corner.x < recs[6][13].x
							&& recs[6][12].y < image_corner.y && image_corner.y < recs[7][12].y
				...
				if (showedge57 == true) {
					if (recs[8][12].x < image_corner.x && image_corner.x < recs[8][13].x
							&& recs[8][12].y < image_corner.y && image_corner.y < recs[9][12].y
							|| recs[10][12].x < image_corner.x && image_corner.x < recs[10][13].x
									&& recs[10][12].y < image_corner.y && image_corner.y < recs[11][12].y) {
						set = true;
						extrarohrmoved = true;
					}
				}
				...
				if (showedge68 == true) {
					if (recs[10][1].x < image_corner.x && image_corner.x < recs[10][2].x
							&& recs[10][1].y < image_corner.y && image_corner.y < recs[11][1].y
							|| recs[12][1].x < image_corner.x && image_corner.x < recs[12][2].x
				...
				if (showedge79 == true) {
					if (recs[10][12].x < image_corner.x && image_corner.x < recs[10][13].x
							&& recs[10][12].y < image_corner.y && image_corner.y < recs[11][12].y
				...
				if (showedge810 == true) {
					if (recs[12][1].x < image_corner.x && image_corner.x < recs[12][2].x
							&& recs[12][1].y < image_corner.y && image_corner.y < recs[13][1].y
							|| recs[14][1].x < image_corner.x && image_corner.x < recs[14][2].x
									&& recs[14][1].y < image_corner.y && image_corner.y < recs[15][1].y) {
						set = true;
						extrarohrmoved = true;
					}
				}
				...
				if (showedge911 == true) {
					if (recs[12][12].x < image_corner.x && image_corner.x < recs[12][13].x
							&& recs[12][12].y < image_corner.y && image_corner.y < recs[13][12].y
							|| recs[14][12].x < image_corner.x && image_corner.x < recs[14][13].x
									&& recs[14][12].y < image_corner.y && image_corner.y < recs[15][12].y) {
						set = true;
						extrarohrmoved = true;
					}
				}
				...
				if (showedge1011 == true) {
					if (recs[14][1].x < image_corner.x && image_corner.x < recs[14][2].x
							&& recs[14][1].y < image_corner.y && image_corner.y < recs[15][1].y
							|| recs[14][12].x < image_corner.x && image_corner.x < recs[14][13].x
									&& recs[14][12].y < image_corner.y && image_corner.y < recs[15][12].y) {
						set = true;
