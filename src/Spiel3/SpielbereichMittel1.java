...
public class SpielbereichMittel1 extends JPanel implements MouseListener, KeyListener, ComponentListener, ActionListener {
	public static int getCellSize() {
		return cellSize;
	}

	public static void setCellSize(int cellSize) {
		SpielbereichMittel1.cellSize = cellSize;
	}
	...
	public static void setGraph(Graph graph) {
		SpielbereichMittel1.graph = graph;
	}
		...
		for (int i = 0; i < graph.knotenanzahl; i++) {
			for (int j = 0; j < graph.knotenanzahl; j++) {
				if (i == 0 && j == 1) {
					...
					g.drawString(gewicht2, (recs[4][12].x + (cellSize / 2) + recs[8][12].x + (cellSize / 2)) / 2,
							(recs[4][12].y + recs[8][12].y) / 2);
				} else if (i == 1 && j == 3) {
					g.setColor(Color.black);
					g.drawLine(recs[5][1].x + (cellSize / 2), recs[5][1].y, recs[8][1].x + (cellSize / 2),
							recs[8][1].y);
					gewicht3 = String.valueOf(graph.adjazenzmatrix[1][3]);
					g.drawString(gewicht3, (recs[4][1].x + (cellSize / 2) + recs[8][1].x + (cellSize / 2)) / 2,
							(recs[4][1].y + recs[8][1].y) / 2);
				} else if (i == 2 && j == 3) {
					g.setColor(Color.black);
					...
					g.drawString(gewicht4, (recs[8][1].x + recs[8][12].x) / 2,
							(recs[8][1].y + (cellSize / 2) + recs[8][12].y + (cellSize / 2)) / 2);
				} else if (i == 2 && j == 4) {
					g.setColor(Color.black);
					g.drawLine(recs[9][12].x + (cellSize / 2), recs[9][12].y, recs[12][12].x + (cellSize / 2),
							recs[12][12].y);
					gewicht5 = String.valueOf(graph.adjazenzmatrix[2][4]);
					g.drawString(gewicht5, (recs[8][12].x + (cellSize / 2) + recs[12][12].x + (cellSize / 2)) / 2,
							(recs[8][12].y + recs[12][12].y) / 2);
				} else if (i == 3 && j == 5) {
					g.setColor(Color.black);
					g.drawLine(recs[9][1].x + (cellSize / 2), recs[9][1].y, recs[12][1].x + (cellSize / 2),
							recs[12][1].y);
					gewicht6 = String.valueOf(graph.adjazenzmatrix[3][5]);
					g.drawString(gewicht6, (recs[8][1].x + (cellSize / 2) + recs[12][1].x + (cellSize / 2)) / 2,
							(recs[8][1].y + recs[12][1].y) / 2);
				} else if (i == 4 && j == 5) {
					g.setColor(Color.black);
					...
					g.drawString(gewicht7, (recs[12][1].x + recs[12][12].x) / 2,
							(recs[12][1].y + (cellSize / 2) + recs[12][12].y + (cellSize / 2)) / 2);
				} else if (i == 4 && j == 6) {
					g.setColor(Color.black);
					g.drawLine(recs[13][12].x + (cellSize / 2), recs[13][12].y, recs[16][12].x + (cellSize / 2),
							recs[16][12].y);
					gewicht8 = String.valueOf(graph.adjazenzmatrix[4][6]);
					g.drawString(gewicht8, (recs[12][12].x + (cellSize / 2) + recs[16][12].x + (cellSize / 2)) / 2,
							(recs[12][12].y + recs[16][12].y) / 2);
				} else if (i == 5 && j == 7) {
					g.setColor(Color.black);
					g.drawLine(recs[13][1].x + (cellSize / 2), recs[13][1].y, recs[16][1].x + (cellSize / 2),
							recs[16][1].y);
					gewicht9 = String.valueOf(graph.adjazenzmatrix[5][7]);
					g.drawString(gewicht9, (recs[12][1].x + (cellSize / 2) + recs[16][1].x + (cellSize / 2)) / 2,
							(recs[12][1].y + recs[16][1].y) / 2);
				} else if (i == 6 && j == 7) {
					g.setColor(Color.black);
					...
					g.drawString(gewicht10, (recs[16][1].x + recs[16][12].x) / 2,
							(recs[16][1].y + (cellSize / 2) + recs[16][12].y + (cellSize / 2)) / 2);
				}
...
//			Extras.getExtrarohr() = extrarohr.getScaledInstance(cellSize, cellSize, java.awt.Image.SCALE_REPLICATE);
		...
		if (showimage02 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[5][12].x, recs[5][12].y, cellSize, recs[12][2].x, null);
		}

		if (showimage13 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[5][1].x, recs[5][1].y, cellSize, recs[1][2].x, null);
		}
		...
		if (showimage24 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[9][12].x, recs[9][12].y, cellSize, recs[12][2].x, null);
		}
		if (showimage35 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[9][1].x, recs[9][1].y, cellSize, recs[1][2].x, null);
		}
		if (showimage45 == true) {
			g.drawImage(Graph.getRohrhorizontal(), recs[12][2].x, recs[12][2].y, recs[12][9].x, cellSize, null);
		}
		if (showimage46 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[13][12].x, recs[13][12].y, cellSize, recs[12][2].x, null);
		}
		if (showimage57 == true) {
			g.drawImage(Graph.getRohrvertikal(), recs[13][1].x, recs[13][1].y, cellSize, recs[1][2].x, null);
		}
		if (showimage67 == true) {
			g.drawImage(Graph.getRohrhorizontal(), recs[16][2].x, recs[16][2].y, recs[16][9].x, cellSize, null);
		}
		if (showbonus == true) {
			g.drawImage(Graph.getBehälter(), recs[a][b].x, recs[a][b].y, cellSize, cellSize, null);
		}
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (mouseclick1 == true) {
			...
			if (recs[5][12].y < e.getY() && e.getY() < recs[7][12].y && recs[5][12].x < e.getX()
					&& e.getX() < recs[5][13].x) {
				if (counter02 == 0) {
					showimage02 = true;
					repaint();
			...
			if (showedge02 == true || showedge23 == true || showedge45 == true || showedge46 == true) {
				if (recs[9][12].y < e.getY() && e.getY() < recs[11][12].y && recs[9][12].x < e.getX()
						&& e.getX() < recs[9][13].x) {
					if (counter24 == 0) {
						showimage24 = true;
						repaint();
			...
			if (showedge23 == true || showedge13 == true || showedge45 == true || showedge57 == true) {
				if (recs[9][1].y < e.getY() && e.getY() < recs[11][1].y && recs[9][1].x < e.getX()
						&& e.getX() < recs[9][2].x) {
					if (counter35 == 0) {
						showimage35 = true;
						repaint();
			...
			if (showedge24 == true || showedge45 == true || showedge67 == true) {
				if (recs[13][12].y < e.getY() && e.getY() < recs[15][12].y && recs[13][12].x < e.getX()
						&& e.getX() < recs[13][13].x) {
					if (counter46 == 0) {
						showimage46 = true;
						repaint();
			...
			if (showedge35 == true || showedge45 == true || showedge67 == true) {
				if (recs[13][1].y < e.getY() && e.getY() < recs[15][1].y && recs[13][1].x < e.getX()
						&& e.getX() < recs[13][2].x) {
					if (counter57 == 0) {
						showimage57 = true;
						repaint();
			...
			if (showedge46 == true || showedge57 == true) {
				if (recs[16][2].x < e.getX() && e.getX() < recs[16][12].x && recs[16][2].y < e.getY()
					...
					if (counter67 == 0) {
						showimage67 = true;
						repaint();
						lösung2 += Integer.valueOf(gewicht10);
						anzahlkanten2 += 1;
						counter67 = 1;
						showedge67 = true;
						abwählen.push("j");
	...
	public void keyPressed(KeyEvent e) {
		...
		if (recs[a][b].x < image_corner.x && image_corner.x < recs[a][b + 1].x && recs[a][b].y < image_corner.y
			...
			} else if (SpielbereichMittel1.angebunden1.size() >= 7 && SpielbereichMittel1.angebunden2.size() >= 7) {
			...
			if (alleangebunden == true && SpielbereichMittel1.lösung2 <= Auswahlbereich.getZielwert2()) {
				showbonus = true;
				repaint();
				...
				Auswahlbereich.setZielwert2(Graph.OptimaleLösung1(spielbereichMittel2.getGraph()));
	...
	public class ClickListener extends MouseAdapter {
		...
		public void mouseReleased(MouseEvent evt) {
			...
			for (int i = 0; i < 7; i++) {
				...
				if (recs[4][12].x < image_corner.x && image_corner.x < recs[4][13].x && recs[4][12].y < image_corner.y
						&& image_corner.y < recs[5][12].y) {
					set = true;
					extrarohrmoved = true;
				}
				...
				if (showedge57 == true) {
					if (recs[12][1].x < image_corner.x && image_corner.x < recs[12][2].x
							&& recs[12][1].y < image_corner.y && image_corner.y < recs[13][1].y
							|| recs[16][1].x < image_corner.x && image_corner.x < recs[16][2].x
